...
router.post("/openai/conversations/:id/messages", async (req, res) => {
  ...
  try {
    ...
    const stream = await openai.chat.completions.create({
      ...
      messages: [
        { role: "system", content: "Siz GilosAI platformasining AI yordamchisisiz. Foydalanuvchi qaysi tilda yozsa, o'sha tilda javob bering. Qisqa, aniq va foydali javoblar bering." },
        ...chatMessages,
      ],
      stream: true,
    });
  ...
  try {
    ...
    const chatResponse = await openai.chat.completions.create({
      ...
      messages: [
        {
          role: "system",
          content: "Siz GilosAI platformasining ovozli AI yordamchisisiz. Qisqa, aniq va foydali javoblar bering. Foydalanuvchi qaysi tilda gapirsa, o'sha tilda javob bering.",
        },
