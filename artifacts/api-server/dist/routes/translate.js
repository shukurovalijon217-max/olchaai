...
router.post("/translate-bundle", async (req, res) => {
    try {
        ...
        for (let i = 0; i < keys.length; i += BATCH_SIZE) {
            ...
            const batch = slice.reduce((acc, k) => { acc[k] = strings[k]; return acc; }, {});
