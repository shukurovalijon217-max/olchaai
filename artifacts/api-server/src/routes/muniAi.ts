...
const WISDOM_SYSTEM = `Sen "Muni AI" — GILOS platformasining shaxsiy AI yordamchisisan.
...
const TRADER_SYSTEM = `Sen "Muni AI" — GILOS platformasining bozor va savdo psixologiyasi bo'yicha AI yordamchisisan.
