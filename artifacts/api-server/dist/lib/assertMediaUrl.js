 ...
 */
export function assertMediaUrl(url, field = "mediaUrl") {
    if (url == null || url === "")
        return; // optional — absence is fine
    if (typeof url !== "string" || !url.startsWith("https://")) {
        throw new Error(`[assertMediaUrl] Invalid ${field}: expected a full HTTPS URL, got "${String(url).slice(0, 120)}". ` +
...
export function assertMediaUrls(urls, field = "mediaUrls") {
    if (urls == null)
        return;
