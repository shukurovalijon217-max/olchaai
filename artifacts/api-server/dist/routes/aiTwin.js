...
router.get("/twin/config", requireAuth, async (req, res) => {
    try {
...
router.post("/twin/config", requireAuth, async (req, res) => {
    try {
...
router.get("/twin/:userRef", async (req, res) => {
    try {
...
router.post("/twin/:userId/chat", requireAuth, async (req, res) => {
    try {
...
router.get("/twin/:userId/chats", requireAuth, async (req, res) => {
    try {
        const twinOwnerId = parseInt(req.params.userId);
        const visitorId = req.session.userId;
