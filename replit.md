...
- **`<title>`/`og:title`/`twitter:title` across `artifacts/nexus/index.html` and `artifacts/spatial-ar/index.html` must say "OlchaAI"** — this literal string is what Google and social previews surface, independent of any in-app logo styling.
