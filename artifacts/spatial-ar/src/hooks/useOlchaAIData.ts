...
const FALLBACK_POSTS: OlchaAIPost[] = [
  {
    id: 1,
    content: "OlchaAI Spatial AR muhitida birinchi postim! Hologramma interfeysi hayratlanarli, kelajak bugun boshlandi 🚀",
  ...
  {
    id: 3,
    content: "Yangi story joylashdim 🔥 OlchaAI Live orqali minglab kishilar tomosha qilmoqda! Kimlar ko'ryapti?",
  ...
  {
    id: 5,
    content: "OlchaAI Go real-time xizmati ishga tushdi. WebSocket orqali jonli yangilanishlar — hech qanday kechikish yo'q! 💚",
