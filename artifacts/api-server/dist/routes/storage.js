...
import { isCloudinaryEnabled, generateUploadSession, streamToCloudinary, getCloudinaryUrl, pingCloudinary, } from "../lib/cloudinaryStorage";
import { isR2Enabled, r2GetPresignedUploadUrl, r2FinalizeUpload, } from "../lib/r2Storage";
const router = Router();
 ...
 */
router.post("/storage/uploads/finalize", async (req, res) => {
    if (!isR2Enabled()) {
 ...
 */
router.get("/storage/cloudinary-check", async (req, res) => {
    if (!isCloudinaryEnabled()) {
        res.json({
            ok: false,
 ...
 */
router.put("/storage/uploads/cloud/:uuid", async (req, res) => {
 ...
 */
router.get("/storage/cloud/:uuid", async (req, res) => {
 ...
 */
router.delete("/storage/objects/delete", async (req, res) => {
