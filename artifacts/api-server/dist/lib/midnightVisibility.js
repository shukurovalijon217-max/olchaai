 ...
 */
export function isWithinMidnightWindow(timezone, now = new Date()) {
 ...
 */
export function midnightVisibilityCondition(timezone) {
    if (isWithinMidnightWindow(timezone))
        return eq(postsTable.midnightOnly, postsTable.midnightOnly);
 ...
 */
export async function midnightVisibilityConditionForReq(req) {
